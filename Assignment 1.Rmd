...
Mankind has significantly advanced over the years especially within the medical and technological areas. With this in mind, has human advancement increased the survivability of mankind? 
...
ggplot(data = pop1, aes(x = Year)) +
  ...
  scale_color_manual(values = c("blue", "dark orange", "turquoise"),
